...
const BusSeatLayout = () => {
    ...
    const renderSeats = () => {
        ...
        for (let i = 1; i <= totalSeats; i++) {
            seats.push(<Seat key={i} seatNumber={i} isSelected={selectedSeats.includes(i)} onClick={() => handleSeatClick(i)} />);
        }
        return seats;
    };
            ...
            <div className='w-full flex justify-between'>
                ...
                <div className="space-y-3 w-28">
                    <div className="flex items-center gap-x-2">
                        ...
                        <p className="text-neutral-900 dark:text-neutral-200 texxt-sm font-normal">
                            Available
                        </p>
                    </div>
                    <div className="flex items-center gap-x-2">
