        ...
        <div className="w-full lg-px-28 md:px-16 sm:px-7 px-4 mt-[13ch] mb-[8ch] space-y-14">
            <div className="w-full grid grid-cols-6 gap-14 bg-neutral-200/60 dark:bg-neutral-900/40 rounded-md px-6 py-5 items-center justify-between">
                <div className="flex items-center gap-x-2.5 col-span-2 ">
                    <input type="number" placeholder='Search buses...' class='seat' id='seat' className='w-full appearance-none text-neutral-800 dark:text-neutral-100 placeholder:text-neutral-400 dark:placeholder:text-neutral-600 inline-block bg-neutral-200/60 dark:bg-neutral-900/60 px-3 h-12 border border-neutral-200 dark:border-neutral-900 rounded-md focus:outline-none focus:bg-neutral-100 dark:focus:bg-neutral-900' />
            ...
            <div className="w-full grid grid-cols-3 gap-10">
                <Link to={"/bus/bus-details"} className='w-full bg-neutral-200/60 block drak:bg-neutral-900/40 rounded-xl p-4'>
